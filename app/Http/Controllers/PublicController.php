...
class PublicController extends Controller
{
    ...
    public function loadCalendar(Request $request)
    {
        ...
        <div class="mj-row mj-calendar-header">
          <div class="mj-col-10" onclick="calendar(this,<?php echo $nexty - 1; ?>,<?php echo $nextm; ?>)">&laquo;</div>
          <div class="mj-col-10" onclick="calendar(this,<?php echo $nexty; ?>,<?php echo $nextm - 1; ?>)">&lsaquo;</div>
          <div class="mj-col-60">
          <?php
          ...
          <div class="mj-col-10" onclick="calendar(this,<?php echo $nexty; ?>,<?php echo $nextm + 1; ?>)">&rsaquo;</div>
          <div class="mj-col-10" onclick="calendar(this,<?php echo $nexty + 1; ?>,<?php echo $nextm; ?>)">&raquo;</div>
        </div>

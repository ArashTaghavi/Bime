...
export default class Reminder extends Component
{
    ...
    render()
    {
        const { disabledBtn, formInputs, insuranceType } = this.state
            ...
            <div className="container reminder-container">
              <div className="reminder-form pt-2">
                  ...
                  <div className="reminder-form-body p-3 p-md-4">
                      <div className="row">
                          <div className="col-sm-6 col-12 mb-3 mt-2 mt-sm-0 pl-3 pl-sm-2">
                  ...
                  <div className="reminder-form-footer pb-3 text-center">
                      <button onClick={this.handleSubmitReminder} disabled={disabledBtn ? 'disabled' : ''} className={disabledBtn ? 'btn btn-primary disabled-btn' : 'btn btn-primary'}>
                          {disabledBtn &&

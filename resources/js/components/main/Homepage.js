...
export default class Homepage extends Component
{
    ...
    render()
    {
        const { cars, carModels, carManufactureYears, damageQtys, disabledBtn,
                        ...
                        {step === 0 &&
                            <div className="insurance-selection-btns mj-rightslide text-center">
                                <div className="row align-row">
                                    <InsuranceSelectionButton insurance={'fire'} persianTitle={'بیمه آتش سوزی'} handleInsuranceSelect={this.handleInsuranceSelect} />
                                    <InsuranceSelectionButton insurance={'body'} persianTitle={'بیمه بدنه'} handleInsuranceSelect={this.handleInsuranceSelect} />
                                    <InsuranceSelectionButton insurance={'earthquake'} persianTitle={'بیمه زلزله'} handleInsuranceSelect={this.handleInsuranceSelect} />
                                    <InsuranceSelectionButton insurance={'life'} persianTitle={'بیمه عمر'} handleInsuranceSelect={this.handleInsuranceSelect} />
                                    <InsuranceSelectionButton insurance={'medic'} persianTitle={'مسئولیت پزشکان'} handleInsuranceSelect={this.handleInsuranceSelect} />
                                    <InsuranceSelectionButton insurance={'treatment'} persianTitle={'درمان تکمیلی'} handleInsuranceSelect={this.handleInsuranceSelect} />
                                    <InsuranceSelectionButton insurance={'thirdparty'} persianTitle={'بیمه شخص ثالث'} handleInsuranceSelect={this.handleInsuranceSelect} />
                                    <InsuranceSelectionButton insurance={'travel'} persianTitle={'بیمه مسافرتی'} handleInsuranceSelect={this.handleInsuranceSelect} />
                                </div>
                            </div>
                        }
